...
<br><br>
    <form method="Post", action="{{route('parcelle.update',$parcelles->id)}}">
        @csrf
        <fieldset><legend> modifier un parcelle  </legend>
            ...
            <div class="row mb-3">
                <label for="nom" class="col-sm-2 col-form-label">Personne morale</label>

                    <select class="form-select" name="dossier_id" aria-label="Default select example">
                        <option selected>choisissez la personne morale correspondant</option>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="lot" value=" {{$parcelles->lot}} " placeholder="entrer lot, exemple: Abdl-Aziz">
                </div>
            </div>
            <div class="row mb-3">
                <label for="section" class="col-sm-2 col-form-label">section</label>
                <input type="text" name="section" value=" {{$parcelles->section}} " id="section">
            </div>

            <div class="row mb-3">
                <label for="lot" class="col-sm-2 col-form-label"  >superficie</label>
                <div class="col-sm-10">
                    <input type="text" name="superficie" value=" {{$parcelles->superficie}} " id="superficie">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-sm-10">
