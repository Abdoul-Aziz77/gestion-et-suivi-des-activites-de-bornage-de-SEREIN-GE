...
@section('parametre')
 ...
 --}}
                                            ...
                                            <li><a class="dropdown-item" data-toggle="modal" data-target="#myModal9"
                                                    href="#"> Ajouter un fichier </a></li>

                                            <li><a class="dropdown-item" data-toggle="modal" data-target="#myModal7"
                                                    href="#">Annuler</a></li>

                                            <li><a class="dropdown-item" data-toggle="modal" data-target="#myModal8"
                                                    href="#"> Suspendre</a></li>
                                ...
                                <div class="modal fadeInDown dark fast undefined animated" id="myModal5" tabindex="-1"
                                    role="dialog" aria-labelledby="myModalLabel " aria-hidden="true">
                                    <div class="modal-dialog modal-lg ">
                                        <div class="modal-body "style="background-color: #2f3542;">
                                            <div class="modal-content" style="background-color: #2f3542;">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="Post", action="{{ route('fichier.store') }}">
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="chemin" class="col-sm-2 col-form-label">chemin
                                                                du fichier</label>
                                                            <div class="col-sm-10">
                                        ...
                                        <div class="modal-body ">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="text-center"> Suspension du dossier
                                                        {{ $dossier->id }}
                                                    </div>
