...
<br><br>
    <form method="Post", action="{{route('but de sortie.create')}}">
        @csrf
        <fieldset><legend> Modifier un but de sortie </legend>
            ...
            <div class="row mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="statut" id="inlineRadio1" value=" {{$butsorties->id==1?$butsorties}} ">
                    <label class="form-check-label" for="inlineRadio1">oui</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="statut" id="inlineRadio2" value=" {{$butsorties->id==0?$butsorties}} ">
